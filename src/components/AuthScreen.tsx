                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className={cn(
                          "w-full pl-14 pr-6 py-5 bg-zinc-50 border-2 border-transparent focus:border-emerald-action focus:bg-zinc-50 rounded-3xl outline-none transition-all font-bold text-zinc-800 dark:text-white",
