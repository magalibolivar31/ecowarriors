  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-[2rem] sm:rounded-[3rem] overflow-hidden border border-zinc-100 shadow-sm">
      ...
      <div className="flex-1 flex flex-col xl:flex-row overflow-hidden min-h-0">
        ...
        <div className="flex-1 bg-white flex flex-col p-4 sm:p-6 space-y-6 lg:space-y-8 overflow-y-auto min-w-[280px] max-h-[30vh] xl:max-h-none shrink-0 border-t xl:border-t-0 xl:border-l border-zinc-100">
          <div>
